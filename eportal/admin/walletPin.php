...
<head>
  ...
  <div class="col-12">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-credit-card-alt fa-1x"></span> E-WALLET SCRATCH CARD PINS </h3>
  </div>
        ...
        <div class="card-body card-dashboard">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped osotechExp table-hover">
              ...
              <tbody>
                <?php 
                $pin_datas = $_Pins_->get_pins("tbl_ewallet_pins");
                 if ($pin_datas!="") {
                  $cnt =1;
               ...
               ?></td>
                  ...
                  <td><button class="btn btn-danger btn-sm round del_pinBtn_" data-table="tewp" data-id="<?php echo $pin_data->pin_id;?>" type="button" title="Click to delete this Pin"><span class="fa fa-trash"></span></button></td>
                </tr>
                  <?php endforeach; ?>
               <?php } ?>
              </tbody>
