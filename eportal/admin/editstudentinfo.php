          ...
          <form class="form form-horizontal" id="student_update_form">
            <div class="form-body">
              <div class="row">
                ...
                <div class="col-md-8 form-group">
                  <input type="text" class="form-control" name="student_reg_number" placeholder="2022C140020001" value="<?php echo $student_data->stdRegNo;?>">
                </div>
                 <div class="col-md-4">
                  <label>Date Of Birth:</label>
                </div>
                <div class="col-md-8 form-group">
                  <input type="date" class="form-control" name="dateofbirth" placeholder="Date of Birth" value="<?php echo $student_data->stdDob;?>">
                </div>
                 <div class="col-md-4">
                ...
                <div class="col-md-8 form-group">
                  <select name="student_status" class="form-control" id="users-list-role">
                            <option value="<?php echo $student_data->stdAdmStatus;?>" selected><?php echo $student_data->stdAdmStatus;?></option>
                ...
                <div class="col-sm-12 d-flex justify-content-end">
                  ...
                  <a href="./ab_students"><button type="button" class="btn btn-danger btn-lg">Go Back</button></a>
                </div>
              </div>
            </div>
          </form>
