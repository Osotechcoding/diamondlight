...
<head>
    ...
    <title><?php echo $SmappDetails->school_name ?> :: Manage Staff Duties</title>
            ...
            <div class="col-md-3 dashboard-users-success">
              <div class="card text-center bg-warning">
                <div class="card-body py-1">
                  ...
                  <h2 class="text-white mb-0"><?php echo $Administration->count_all_staff_asigned($activeSess->term_desc,$activeSess->session_desc_name); ?></h2>
    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header">
          <h4 class="text-center">STAFF ON DUTY FOR THE <?php echo $activeSess->session_desc_name;?> ACADEMIC SESSION </h4>
        </div>
        <div class="card-body card-dashboard">
          <button type="button" class="btn btn-dark btn-md btn-rounded" data-toggle="modal" data-target="#dutyModalForm"><span class="fa fa-user-plus fa-1x"></span> Assign Duty</button>
              ...
              <div class="row">
                 <div class="col-md-6 col-12">
                  <div class="form-label-group">
                    <input type="text" class="form-control" placeholder="Session" name="csession" value="<?php echo $activeSess->session_desc_name;?>" readonly>
