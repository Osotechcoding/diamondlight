...
<head>
    ...
    <title><?php echo $SmappDetails->school_name ?> :: Online Lecture</title>
...
iframe[seamless] {
 ...
 <div class="col-12 mb-2">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-comments-o fa-1x"></span> ONLINE LECTURE MODULE</h3>
  </div>
</div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-center">
              <div class="modal-content">
                <div class="modal-header">
                  <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i class="fa fa-files-o fa-1x"></i> Upload Virtual Lecture</h2>
