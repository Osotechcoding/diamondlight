  ...
  <?php include ("template/Sidebar.php"); ?>
             ...
             <div class="col-md-4 dashboard-users-success">
              ...
              <div class="card text-center bg-dark">
                <div class="card-body py-1">
                  ...
                  <h2 class="text-white mb-0">40.00</h2>
    ...
    <div class="card">
      <div class="card-header">
          <button type="button" class="btn btn-dark btn-md btn-rounded" data-toggle="modal" data-target="#addHolidayModal"><i class="fa fa-calendar fa-2x"></i> Add Event</button>
        </div>
      <div class="card-body">
